      ...
      <header className="sticky top-0 z-50 bg-card/80 backdrop-blur-md border-b border-border">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-7">
            <Link to="/outils" className="text-muted-foreground hover:text-primary font-semibold text-sm transition-colors">Outils</Link>
            <Link to="/tarifs" className="text-muted-foreground hover:text-primary font-semibold text-sm transition-colors">Tarifs</Link>
            <Link to="/securite" className="text-muted-foreground hover:text-primary font-semibold text-sm transition-colors">Sécurité</Link>
            <Link to="/a-propos" className="text-muted-foreground hover:text-primary font-semibold text-sm transition-colors">À propos</Link>
            <Link to="/mentions-legales" className="text-muted-foreground hover:text-primary font-semibold text-sm transition-colors">Légal</Link>
          </nav>

          <div className="flex items-center gap-3">
            <button
              onClick={() => setHistoryOpen(true)}
              className="w-9 h-9 flex items-center justify-center rounded-lg border border-border bg-secondary hover:bg-secondary/80 transition"
